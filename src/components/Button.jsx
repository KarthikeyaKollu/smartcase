...
export const Button = () => {
  ...
  return (
    <div style={{display:"flex",alignItems:"center",justifyContent:"center"}}>
      <Buttton onClick={handleAnimationClick}>  <LottieAnimation autoplay={isAnimationPlaying} width="60px" height="60px" /> {!isAnimationPlaying?"Start Measuring":"Stop Measuring"} </Buttton>
    </div>
  )
}
